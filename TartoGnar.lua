...
function TartoGnar:LoadMenu()
	...
	TartoGnar.Menu:MenuElement({id = "LaneClear", name = "[SOON]LaneClear", type = MENU})
	TartoGnar.Menu:MenuElement({id = "Harass", name = "Harass", type = MENU})
	TartoGnar.Menu:MenuElement({id = "LastHit", name = "[SOON]LastHit", type = MENU})
	TartoGnar.Menu:MenuElement({id = "Killsteal", name = "[SOON]Killsteal", type = MENU})
